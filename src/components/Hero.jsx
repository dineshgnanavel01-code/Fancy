...
import { ArrowRight, Sparkles, ShoppingBag, Eye, Star, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function Hero() {
  ...
  const heroSlides = [
    { 
      ...
      hoverImage: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&w=1400&q=90",
      label: "Featured Spotlight", 
      title: "The Velvet & Gold Capsule", 
      description: "Timeless silhouettes with a modern luxury edge." 
    },
    { 
      id: 2, 
      image: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&w=1400&q=90", 
      hoverImage: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=1400&q=90",
      label: "New Collection", 
      title: "Modern Muse Collection", 
      description: "Elegant tailoring designed for unforgettable moments." 
    },
    { 
      id: 3, 
      image: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=1400&q=90", 
      hoverImage: "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=1400&q=90",
      label: "Editor's Choice", 
      title: "The Golden Hour Edit", 
      description: "Refined essentials for effortless everyday luxury." 
    },
    { 
      id: 4, 
      image: "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=1400&q=90", 
      hoverImage: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=1400&q=90",
      label: "Limited Edition", 
      title: "After Dark Atelier", 
      description: "Statement fashion crafted for the modern icon." 
    },
  ];
  ...
  const rotateX = useSpring(
    useTransform(mouseY, [-0.3, 0.3], [12, -12]),
    springConfig
  );
  const rotateY = useSpring(
    useTransform(mouseX, [-0.3, 0.3], [-12, 12]),
    springConfig
  );

  const glareX = useSpring(
    useTransform(mouseX, [-0.3, 0.3], [0, 100]),
    springConfig
  );
  const glareY = useSpring(
    useTransform(mouseY, [-0.3, 0.3], [0, 100]),
    springConfig
  );
  ...
  const handleMouseMove = (e) => {
    ...
    mouseX.set(currentMouseX / width - 0.3);
    mouseY.set(currentMouseY / height - 0.3);
  };
          ...
          >
            ...
            <div className="relative h-[620px] w-full overflow-hidden">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  />
                  <img
                    src={activeSlide.hoverImage}
                    alt={`${activeSlide.title} alternate view`}
            ...
            <div className="absolute top-6 right-6 z-30 flex items-center gap-2">
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={prevSlide}
                className="flex h-10 w-10 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md transition hover:bg-[#a17b38]"
              ...
              {heroSlides.map((slide, idx) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-500 ${
                    currentIndex === idx ? "w-6 bg-[#d5b777]" : "w-2 bg-white/50"
                  }`}
            ...
            <motion.div
              style={{ translateZ: 50 }}
              className="absolute bottom-6 left-6 right-6 rounded-2xl border border-white/30 bg-black/40 p-6 text-white shadow-2xl backdrop-blur-xl transition-all duration-300 z-30"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[10px] uppercase tracking-[0.25em] text-[#d5b777]">
                    {isHovered ? "Hover View Active" : activeSlide.label}
                  </p>
                ...
                <motion.span
                  ...
                  className="flex h-12 w-12 items-center justify-center rounded-full bg-[#a17b38] text-white shadow-lg transition-colors hover:bg-white hover:text-black shrink-0"
                >
                  <ArrowRight size={20} />
                </motion.span>
              </div>
